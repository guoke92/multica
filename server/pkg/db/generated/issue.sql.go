...
) RETURNING id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, origin_type, origin_id, first_executed_at, start_date, metadata, source_room_id, source_message_id
`
...
const createIssueWithRoomSource = `-- name: CreateIssueWithRoomSource :one
INSERT INTO issue (
    workspace_id, title, description, status, priority,
    assignee_type, assignee_id, creator_type, creator_id,
    parent_issue_id, position, start_date, due_date, number, project_id,
...
type CreateIssueWithRoomSourceParams struct {
	WorkspaceID   pgtype.UUID        `json:"workspace_id"`
	Title         string             `json:"title"`
	Description   pgtype.Text        `json:"description"`
	Status        string             `json:"status"`
...
func (q *Queries) CreateIssueWithRoomSource(ctx context.Context, arg CreateIssueWithRoomSourceParams) (Issue, error) {
	row := q.db.QueryRow(ctx, createIssueWithRoomSource,
		arg.WorkspaceID,
		arg.Title,
		arg.Description,
		arg.Status,
...
SELECT id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, origin_type, origin_id, first_executed_at, start_date, metadata, source_room_id, source_message_id FROM issue
WHERE workspace_id = $1
